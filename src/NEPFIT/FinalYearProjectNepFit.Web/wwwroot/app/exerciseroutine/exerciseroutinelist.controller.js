        ...
        function activate() {
            vm.mainGridOptions = {
                ...
                columns: [
                    {
                        width: "35px",
                        template: '<i ng-click=" vm.showEditExerciseRoutine(dataItem)" class="fa fa-pencil handCursor"></i>'
                    },
                    {
                        title: 'Name',
                        field: 'name'
                    ...
                    {
                        width: "35px",
                        template: '<i ng-click=" vm.removeExerciseRoutineRequest(dataItem)" class="fa fa-trash handCursor"></i>'
                    }
                ]
            };
