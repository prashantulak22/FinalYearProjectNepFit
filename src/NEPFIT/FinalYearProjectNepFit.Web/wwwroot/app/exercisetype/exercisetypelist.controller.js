        ...
        function activate() {
            vm.mainGridOptions = {
                ...
                columns: [
                    {
                        width: "35px",
                        template: '<i ng-click=" vm.showEditExerciseType(dataItem)" class=" fa fa-pencil handCursor"></i>'
                    },
                    {
                        title: 'Name',
                        field: 'name'
                    ...
                    {
                        width: "35px",
                        template: '<i ng-click=" vm.removeExerciseTypeRequest(dataItem)" class="fa fa-trash handCursor"></i>'
                    }
                ]
            };
